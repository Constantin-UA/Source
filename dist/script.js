        ...
        switch (item.nodeName) {
          ...
          case 'INPUT':
            if (item.getAttribute('type') === 'checkbox') {
              i === 0 ? state[prop] = 'Холодное' : state[prop] = 'Тeплое';
...
var images = function images() {
  ...
  imgPopup.classList.add('animate__animate');
  imgPopup.classList.add('animate__fadeInLeft');
...
var timer = function timer(id, deadline) {
  ...
  var getTimeRemainint = function getTimeRemainint(endtime) {
  ...
  var setClock = function setClock(selector, endtime) {
    ...
    function updateClock() {
      var t = getTimeRemainint(endtime);
